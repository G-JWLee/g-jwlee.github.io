...
- **Curriculum Learning:** I aim to discover skills in Large Vision-Language Models and use them to optimize instruction tuning data order to enhance training efficiency ([Empirical Study](./assets/files/Skill_based_Curriculumn_Learning_for_Large_Vison_Language_Models.pdf)).
